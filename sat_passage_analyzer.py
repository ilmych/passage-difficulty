...
def extract_json_from_response(response_text):
    ...
    if match:
        ...
        try:
            ...
            print("JSON decoding failed after extraction:", e)
            return None
    else:
...
class SATPassageAnalyzer:
    ...
    def init_anthropic_client(self, api_key=None, model="claude-3-7-sonnet-20250219"):
        ...
        try:
            ...
            print("Error: anthropic package not installed. Please install with 'pip install anthropic'")
            return None
        
        # Get API key from parameter or environment variable
        api_key = api_key or environ.get('ANTHROPIC_API_KEY')
        if not api_key:
            print("Error: No API key provided. Set ANTHROPIC_API_KEY environment variable or pass api_key parameter")
            return None
        ...
        try:
            ...
            print(f"Anthropic API client initialized successfully with model {model}")
    ...
    def calculate_flesch_kincaid(self):
        ...
        for passage in self.passages:
            ...
            try:
                ...
                print(f"Exception when calculating Flesch-Kincaid grade for passage {passage_id}: {e}")
                fk_scores.append({
                    'passage_id': passage_id,
                    'title': passage.get('title', f"Passage {passage_id}"),
    ...
    def calculate_avg_sentence_length(self):
        ...
        for passage in self.passages:
            ...
            try:
                ...
                print(f"Exception when calculating average sentence length for passage {passage_id}: {e}")
    ...
    def calculate_readability_score(self):
        ...
        if not self.metrics['readability']:
            print("Warning: No readability metrics calculated yet. Please calculate metrics first.")
            return []
    ...
    def calculate_lexile_scores(self):
        ...
        for passage in self.passages:
            ...
            try:
                ...
                print(f"Exception when calculating Lexile score for passage {passage_id}: {e}")
                lexile_scores.append({
                    'passage_id': passage_id,
                    'title': passage.get('title', f"Passage {passage_id}"),
                    'lexile_score': None,
    ...
    def calculate_vocabulary_difficulty_ratio(self, oxford_wordlist_path='Oxford 5000.txt'):
        ...
        try:
            ...
            print(f"Loaded {len(common_words)} common words from Oxford 5000 list")
        except Exception as e:
            print(f"Error loading Oxford 5000 word list: {e}")
            print("Using an empty set as fallback - results will not be accurate")
            common_words = set()
        ...
        for passage in self.passages:
            ...
            try:
                ...
                if not unique_words:
                    print(f"Warning: No valid words found in passage {passage_id}")
                    continue
                ...
                print(f"Exception when calculating vocabulary difficulty for passage {passage_id}: {e}")
    ...
    def calculate_academic_word_usage(self, academic_wordlist_path='Oxford Phrasal Academic Lexicon.txt'):
        ...
        try:
            ...
            print(f"Loaded {len(academic_words)} terms from Oxford Phrasal Academic Lexicon")
        except Exception as e:
            print(f"Error loading academic word list: {e}")
            print("Using an empty set as fallback - results will not be accurate")
            academic_words = set()
        ...
        for passage in self.passages:
            ...
            try:
                ...
                print(f"Exception when calculating academic word usage for passage {passage_id}: {e}")
    ...
    def calculate_domain_specific_terminology(self, system_prompt=None):
        ...
        for passage in self.passages:
            ...
            try:
                ...
                print(f"Exception when calculating domain-specific terminology for passage {passage_id}: {e}")
    ...
    def calculate_subordinate_clauses(self, api_key=None):
        ...
        for passage in self.passages:
            ...
            try:
                ...
                print(f"Exception when calculating subordinate clauses for passage {passage_id}: {e}")
    ...
    def calculate_syntactic_variety(self, system_prompt=None):
        ...
        for passage in self.passages:
            ...
            try:
                ...
                print(f"Exception when calculating syntactic variety for passage {passage_id}: {e}")
    ...
    def calculate_structural_inversions(self, system_prompt=None):
        ...
        for passage in self.passages:
            ...
            try:
                ...
                print(f"Exception when calculating structural inversions for passage {passage_id}: {e}")
    ...
    def calculate_embedded_clauses(self, system_prompt=None):
        ...
        for passage in self.passages:
            ...
            try:
                ...
                print(f"Exception when calculating embedded clauses for passage {passage_id}: {e}")
    ...
    def calculate_abstraction_level(self, system_prompt=None):
        ...
        for passage in self.passages:
            ...
            try:
                ...
                print(f"Exception when calculating abstraction level for passage {passage_id}: {e}")
    ...
    def calculate_concept_familiarity(self, system_prompt=None):
        ...
        for passage in self.passages:
            ...
            try:
                ...
                print(f"Exception when calculating concept familiarity for passage {passage_id}: {e}")
    ...
    def calculate_implied_information(self, system_prompt=None):
        ...
        for passage in self.passages:
            ...
            try:
                ...
                print(f"Exception when calculating implied information for passage {passage_id}: {e}")
    ...
    def calculate_argumentative_complexity(self, system_prompt=None):
        ...
        for passage in self.passages:
            ...
            try:
                ...
                print(f"Exception when calculating argumentative complexity for passage {passage_id}: {e}")
    ...
    def calculate_organizational_clarity(self, system_prompt=None):
        ...
        for passage in self.passages:
            ...
            try:
                ...
                print(f"Exception when calculating organizational clarity for passage {passage_id}: {e}")
    ...
    def calculate_transitional_elements(self, system_prompt=None):
        ...
        for passage in self.passages:
            ...
            try:
                ...
                print(f"Exception when calculating transitional elements for passage {passage_id}: {e}")
    ...
    def calculate_prior_knowledge_requirements(self, system_prompt=None):
        ...
        for passage in self.passages:
            ...
            try:
                ...
                print(f"Exception when calculating prior knowledge requirements for passage {passage_id}: {e}")
    ...
    def calculate_disciplinary_perspective(self, system_prompt=None):
        ...
        for passage in self.passages:
            ...
            try:
                ...
                print(f"Exception when calculating disciplinary perspective for passage {passage_id}: {e}")
    ...
    def calculate_language_modernity(self, system_prompt=None):
        ...
        for passage in self.passages:
            ...
            try:
                ...
                print(f"Exception when calculating language modernity for passage {passage_id}: {e}")
    ...
    def calculate_inference_requirement(self, system_prompt=None):
        ...
        for passage in self.passages:
            ...
            try:
                ...
                print(f"Exception when calculating inference requirement for passage {passage_id}: {e}")
    ...
    def calculate_figurative_language(self, system_prompt=None):
        ...
        for passage in self.passages:
            ...
            try:
                ...
                print(f"Exception when calculating figurative language for passage {passage_id}: {e}")
    ...
    def calculate_authors_purpose(self, system_prompt=None):
        ...
        for passage in self.passages:
            ...
            try:
                ...
                print(f"Exception when calculating author's purpose for passage {passage_id}: {e}")
    ...
    def export_summary_to_csv(self, filename='passage_difficulty_summary.csv'):
        ...
        try:
            ...
            print(f"Summary successfully saved to {os.path.abspath(filename)}")
            return os.path.abspath(filename)
        except Exception as e:
    ...
    def evaluate_passages(self, api_key=None):
        ...
        print("Starting comprehensive passage evaluation...")
        ...
        if hasattr(self, 'anthropic_client') and self.anthropic_client:
            ...
            print("To calculate all metrics, please provide an API key or set the ANTHROPIC_API_KEY environment variable.")
        ...
        print("\nEvaluation complete!")
        print(f"Analyzed {len(self.passages)} passages across {len(self.metrics)} metric categories.")
        ...
        for i, score in enumerate(overall_scores):
            ...
            print(f"{i+1}. {score['title']} (ID: {score['passage_id']}): " + 
